...
class ShopServiceTest {
    ...
    void getAllOrdersWithOrderStatusTest() {
        ...
        Order order1 = new Order("-1", List.of(new Product("1", "Apfel"), new Product("2", "Birne")), OrderStatus.PROCESSING, ZonedDateTime.now());
        Order order2 = new Order("-2", List.of(new Product("1", "Apfel"), new Product("2", "Birne")), OrderStatus.COMPLETED, ZonedDateTime.now());
        Order order3 = new Order("-3", List.of(new Product("1", "Apfel"), new Product("2", "Birne")), OrderStatus.COMPLETED, ZonedDateTime.now());
        ...
        Order expected = new Order("-2", List.of(new Product("2", "Birne")), OrderStatus.COMPLETED, ZonedDateTime.now());
    ...
    void getAllOrdersWithOrderStatusTwoOrdersTest() {
        ...
        Order order1 = new Order("-1", List.of(new Product("1", "Apfel"), new Product("2", "Birne")), OrderStatus.PROCESSING, ZonedDateTime.now());
        Order order2 = new Order("-2", List.of(new Product("1", "Apfel"), new Product("2", "Birne")), OrderStatus.PROCESSING, ZonedDateTime.now());
        Order order3 = new Order("-3", List.of(new Product("1", "Apfel"), new Product("2", "Birne")), OrderStatus.COMPLETED, ZonedDateTime.now());
        OrderRepo orderRepo = new OrderMapRepo();
        orderRepo.addOrder(order1);
        orderRepo.addOrder(order2);
